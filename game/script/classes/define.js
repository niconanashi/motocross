...
(function (define) {
    ...
    define.CAUTION_TIME_CONDITION = 60;
    ...
    /** 上昇アニメの再生速度 */
    define.PLAYSPEED_UP = 0.3;
    /** 下降アニメの再生速度 */
    define.PLAYSPEED_DOWN = 0.3;
    /** スクロール速度[px/フレーム]：分子 */
    ...
    /** PCのあたり判定矩形 */
    define.COLLISION_PC = {
        x: -9 + 3, y: -30, width: 18 - 8, height: 35 - 9
    };
    /** 障害物のあたり判定矩形配列：カモメ */
    ...
    define.COLLISIONS_SHARK = [
        { x: 34, y: 100, width: 147, height: 54 },
        { x: 96, y: 100, width: 28, height: 84 }
    ];
