                ...
                var CacheableE = function(_super) {
                    ...
                    return __extends(CacheableE, _super), CacheableE.prototype.invalidate = function() {
                        ...
                        !(2 & this.state)) {
                            ...
                            isNew && (this._cache && !this._cache.destroyed() && this._cache.destroy(), this._cache = this.scene.game.resourceFactory.createSurface(Math.ceil(this._cacheSize.width), Math.ceil(this._cacheSize.height)), 
                        ...
                        return this._cache && this._cacheSize.width > 0 && this._cacheSize.height > 0 && renderer.drawImage(this._cache, 0, 0, this._cacheSize.width, this._cacheSize.height, 0, 0), 
            ...
            !function(g) {
                var Game = function() {
                    function Game(gameConfiguration, resourceFactory, assetBase, selfId, operationPluginViewInfo) {
                        ...
                        this.skippingChanged = new g.Trigger(), this._loaded = new g.Trigger(), this._started = new g.Trigger(), 
                        this.isLoaded = !1, this.snapshotRequest = new g.Trigger(), this.external = {}, 
                        this.logger = new g.Logger(this), this._main = gameConfiguration.main, this._mainParameter = void 0, 
                        this._configuration = gameConfiguration, this._assetManager = new g.AssetManager(this, gameConfiguration.assets, gameConfiguration.audio, gameConfiguration.moduleMainScripts);
                    ...
                    return Object.defineProperty(Game.prototype, "focusingCamera", {
                        ...
                        throw g.ExceptionFactory.createPureVirtualError("Game#getCurrentTime");
                        ...
                        this._audioSystemManager._reset(), this._loaded.removeAllByHandler(this._start), 
                        this.join._reset(), this.leave._reset(), this.seed._reset(), this.resized._reset(), 
                        this.skippingChanged._reset(), this._idx = 0, this._localIdx = 0, this._cameraIdx = 0, 
