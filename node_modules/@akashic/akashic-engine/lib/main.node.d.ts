...
declare namespace g {
     ...
     */
    interface PureVirtualError extends Error {
        cause?: any;
    }
    /**
     * アサーションエラー。
    ...
    module ExceptionFactory {
        function createPureVirtualError(methodName: string, cause?: any): PureVirtualError;
...
declare namespace g {
    ...
    class ResourceFactory {
         ...
         */
        createGlyphFactory(fontFamily: FontFamily | string | (g.FontFamily | string)[], fontSize: number, baselineHeight?: number, fontColor?: string, strokeWidth?: number, strokeColor?: string, strokeOnly?: boolean, fontWeight?: FontWeight): GlyphFactory;
...
declare namespace g {
     ...
     */
    class Asset implements Destroyable {
        id: string;
        path: string;
        originalPath: string;
     ...
     * Scene#assets、またはGame#assetsによって取得して利用する。
     */
    class VideoAsset extends ImageAsset {
        /**
         * 動画の本来の幅。
         *
...
declare namespace g {
     ...
     */
    class Trigger<T> implements Destroyable {
        /**
         * チェイン先のTrigger。
     ...
     * チェイン条件を指定出来るTrigger。
     */
    class ConditionalChainTrigger<T> extends Trigger<T> {
        filter: (e: T) => boolean;
        filterOwner: any;
        /**
...
declare namespace g {
     ...
     */
    interface TileParameterObject extends CacheableEParameterObject {
        /**
...
declare namespace g {
     ...
     */
    class Game implements Registrable<E> {
        /**
...
declare namespace g {
    ...
    class Renderer {
        ...
        drawSprites(surface: g.Surface, offsetX: number[], offsetY: number[], width: number[], height: number[], canvasOffsetX: number[], canvasOffsetY: number[], count: number): void;
        /**
...
declare namespace g {
     ...
     */
    class Surface implements CommonSize, Destroyable {
        /**
         * 描画領域の幅。
         * この値を直接書き換えてはならない。
         */
...
declare namespace g {
    ...
    class BitmapFont implements Font {
         ...
         */
        constructor(src: Surface | Asset, map: {
            [key: string]: GlyphArea;
        }, defaultGlyphWidth: number, defaultGlyphHeight: number, missingGlyph?: GlyphArea);
        /**
...
declare namespace g {
    ...
    class Pane extends CacheableE {
         ...
         */
        constructor(scene: Scene, width: number, height: number, backgroundImage?: ImageAsset | Surface, padding?: CommonRect | number, backgroundEffector?: SurfaceEffector);
        /**
...
declare namespace g {
    ...
    class DynamicFont implements Font {
         ...
         */
        constructor(fontFamily: FontFamily, size: number, game: Game, hint?: DynamicFontHint, fontColor?: string, strokeWidth?: number, strokeColor?: string, strokeOnly?: boolean);
        /**
...
declare namespace g {
     ...
     */
    interface MultiLineLabelParameterObject extends CacheableEParameterObject {
        /**
         * 描画する文字列。
         */
        text: string;
     ...
     */
    class MultiLineLabel extends CacheableE {
        /**
         * 描画する文字列。
         * この値を変更した場合、 `this.invalidate()` を呼び出す必要がある。
         */
